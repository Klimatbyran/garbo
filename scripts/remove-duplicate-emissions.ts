...
async function removeDuplicatesFromScope3Category() {
  try {
    ...
    for (const duplicate of duplicates) {
      ...
      console.log(
        `Processing duplicates for scope3Id=${scope3Id}, category=${category}`
      )
      ...
      if (!metadataWithTimestamps || metadataWithTimestamps.length <= 1) {
        console.warn(
          `No duplicate metadata entries found for scope3Id=${scope3Id}, category=${category}. Skipping...`
        )
        continue
      }
...
async function removeDuplicatesFromScope1() {
  try {
    ...
    for (const duplicate of duplicates) {
      ...
      if (!metadataWithTimestamps || metadataWithTimestamps.length <= 1) {
        console.warn(
          `No duplicate metadata entries found for emissionsId=${emissionsId}. Skipping...`
        )
        continue
      }
...
async function removeDuplicatesFromScope1And2() {
  try {
    ...
    console.log(
      'Duplicate removal process for Scope1And2 completed successfully!'
    )
  } catch (error) {
...
async function removeDuplicatesFromBiogenicEmissions() {
  try {
    ...
    console.log(
      'Duplicate removal process for BiogenicEmissions completed successfully!'
    )
  } catch (error) {
...
async function removeDuplicatesFromTurnover() {
  try {
    ...
    for (const duplicate of duplicates) {
      ...
      if (!metadataWithTimestamps || metadataWithTimestamps.length <= 1) {
        console.warn(
          `No duplicate metadata entries found for economyId=${economyId}. Skipping...`
        )
        continue
      }
    ...
    console.log(
      'Duplicate removal process for Turnover completed successfully!'
    )
  } catch (error) {
...
async function removeDuplicatesFromEmployees() {
  try {
    ...
    console.log(
      'Duplicate removal process for Employees completed successfully!'
    )
  } catch (error) {
...
async function removeDuplicatesFromStatedTotalEmissionsByScope3() {
  try {
    ...
    for (const duplicate of duplicates) {
      ...
      if (!metadataWithTimestamps || metadataWithTimestamps.length <= 1) {
        console.warn(
          `No duplicate metadata entries found for scope3Id=${scope3Id}. Skipping...`
        )
        continue
      }
    ...
    console.log(
      'Duplicate removal process for StatedTotalEmissions by Scope3 completed successfully!'
    )
  } catch (error) {
    console.error(
      'Error removing duplicates from StatedTotalEmissions by Scope3:',
      error
    )
  }
}
...
async function removeDuplicatesFromStatedTotalEmissionsByEmission() {
  try {
    ...
    console.log(
      'Duplicate removal process for StatedTotalEmissions by Emission completed successfully!'
    )
  } catch (error) {
    console.error(
      'Error removing duplicates from StatedTotalEmissions by Emission:',
      error
    )
  }
}
