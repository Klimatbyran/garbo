...
const GICS_2023 = {
  ...
  '15105020': {
    name: 'Paper Products',
    description:
      'Manufacturersof all grades of paper. Excludes companies specializing in paper packaging classified in the Paper Packaging Sub-Industry.',
  },
  '20101010': {
    name: 'Aerospace & Defense',
    description:
  ...
  '25202010': {
    name: 'Leisure Products',
    description:
      'Manufacturers of leisure products and equipment includingsports equipment, bicycles and toys.',
  },
  '25203010': {
  ...
  '25504050': {
    ...
    description:
      'Ownersand operators of stores specializing in automotive retail.  Includes auto dealers, gas stations, and retailers of auto accessories, motorcycles & parts, automotive glass, and automotive equipment & parts.',
  },
  '25504060': {
  ...
  '30202010': {
    ...
    description:
      'Producers of agricultural products. Includes crop growers, owners of plantations and companies that produce and process foods but do not package and market them. Excludescompanies classified in the Forest Products Sub-Industry and those that package and market the food products classified in the Packaged Foods Sub-Industry.',
  },
  '30202030': {
  ...
  '35102020': {
    ...
    description:
      'Owners and operatorsof health care facilities, including hospitals, nursing homes, rehabilitation centers and animal hospitals.',
  },
  '35102030': {
  ...
  '50101020': {
    ...
    description:
      'Operators of primarily fixed-line telecommunications networks and companies providing both wireless and fixed-line telecommunicationsservices not classified elsewhere. Also includes internet service providers offering internet access to end users.',
  },
  '50102010': {
    name: 'Wireless Telecommunication Services',
    description:
...
function prepareCodes() {
  ...
  for (const subIndustryCode of subIndustries) {
    const sectorCode = subIndustryCode.slice(0, 2)
    const groupCode = subIndustryCode.slice(0, 4)
    const industryCode = subIndustryCode.slice(0, 6)

    gicsCodes.push({
      sectorCode,
      sectorName: GICS_2023[sectorCode].name,
      groupCode,
      groupName: GICS_2023[groupCode].name,
      industryCode,
      industryName: GICS_2023[industryCode].name,
      subIndustryCode,
      subIndustryName: GICS_2023[subIndustryCode].name,
      subIndustryDescription: GICS_2023[subIndustryCode].description,
    })
  }
