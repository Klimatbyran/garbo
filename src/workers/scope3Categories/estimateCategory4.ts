  ...
  async (job) => {
    ...
    const response = await askStream(
      [
        {
          role: 'system',
          content: 'You are an expert in Scope 3 Category 4 emissions calculation and transportation logistics analysis.'
        },
        {
          role: 'user',
      ...
      {
        response_format: zodResponseFormat(schema, 'scope3-category4')
      }
    )
