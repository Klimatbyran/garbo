    ...
    switch (language) {
        case "en":
            return `{{Infobox company
                | scope1 = ${resolveStatedTotal(emissions.statedTotalEmissions)} ${emissions.statedTotalEmissions?.unit}
            }}`
        case "sv":
    ...
    switch (language) {
        case "en":
            ...
            if (emissions.statedTotalEmissions) {
                enText += ` ${resolveStatedTotal(emissions.statedTotalEmissions)} ${emissions.statedTotalEmissions.unit}`
            }
        ...
        case "sv":
            ...
            if (emissions.statedTotalEmissions) {
                svText += ` ${resolveStatedTotal(emissions.statedTotalEmissions)} ${emissions.statedTotalEmissions.unit}`
            }
            if (emissions.statedTotalEmissions && (emissions.scope1?.total || emissions.scope2?.lb || emissions.scope2?.mb || emissions.scope3?.statedTotalEmissions?.total)) {
                svText += ', varav'
            }
