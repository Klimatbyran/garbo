...
**Data Output Format**:
Present the extracted data in a structured JSON format, including all information you have receive from the previous steps. Never include any comments in the JSON output.
