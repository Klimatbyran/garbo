...
export const InputNationalDataSchema = z.array(
  z.object({
    ...
    logoUrl: z.string().nullable().optional(),
    emissions: InputYearlyDataSchema,
    biogenicEmissions: InputYearlyDataSchema.optional(),
    consumptionAbroadEmissions: InputYearlyDataSchema.optional(),
    exportOfOilProductsEmissions: InputYearlyDataSchema.optional(),
    totalTrend: z.number(),
    totalCarbonLaw: z.number(),
    approximatedHistoricalEmission: InputYearlyDataSchema,
    trend: InputYearlyDataSchema,
...
export const NationDataSchema = z.object({
  ...
  logoUrl: z.string().nullable().optional(),
  emissions: z.array(YearlyDataSchema),
  biogenicEmissions: z.array(YearlyDataSchema).optional(),
  consumptionAbroadEmissions: z.array(YearlyDataSchema).optional(),
  exportOfOilProductsEmissions: z.array(YearlyDataSchema).optional(),
  totalTrend: z.number(),
  totalCarbonLaw: z.number(),
  approximatedHistoricalEmission: z.array(YearlyDataSchema),
  trend: z.array(YearlyDataSchema),
