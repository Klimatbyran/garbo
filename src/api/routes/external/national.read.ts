  ...
  app.get(
    '/',
    {
      schema: {
        ...
        description:
          'Retrieve national (Sweden) data with territorial fossil, production-based, biogenic, consumption abroad, oil export, and e-commerce emissions. Returns 304 Not Modified if the resource has not changed since the last request (based on ETag).',
        tags: getTags('Nation'),
