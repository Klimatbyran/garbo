/*
  ...
  - You are about to drop the column `dataOrigin` on the `Metadata` table. All the data in the column will be lost.
  ...
  - Added the required column `groupName` to the `IndustryGics` table without a default value. This is not possible if the table is not empty.
  - Added the required column `industryName` to the `IndustryGics` table without a default value. This is not possible if the table is not empty.
  - Added the required column `sectorName` to the `IndustryGics` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `subIndustryName` to the `IndustryGics` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "IndustryGics" ADD COLUMN     "groupName" TEXT NOT NULL,
ADD COLUMN     "industryName" TEXT NOT NULL,
ADD COLUMN     "sectorName" TEXT NOT NULL,
ADD COLUMN     "subIndustryDescription" TEXT NOT NULL,
ADD COLUMN     "subIndustryName" TEXT NOT NULL;

-- AlterTable
ALTER TABLE "Initiative" DROP COLUMN "metadataId";

-- AlterTable
ALTER TABLE "Metadata" DROP COLUMN "dataOrigin",
ADD COLUMN     "baseYearId" INTEGER,
