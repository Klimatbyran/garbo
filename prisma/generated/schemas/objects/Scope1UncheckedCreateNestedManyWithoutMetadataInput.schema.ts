...
const Schema: z.ZodType<Prisma.Scope1UncheckedCreateNestedManyWithoutMetadataInput> =
  z
    .object({
      create: z
        .union([
...
export const Scope1UncheckedCreateNestedManyWithoutMetadataInputObjectSchema =
  Schema
