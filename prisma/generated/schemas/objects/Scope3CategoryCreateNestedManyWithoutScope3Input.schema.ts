...
const Schema: z.ZodType<Prisma.Scope3CategoryCreateNestedManyWithoutScope3Input> =
  z
    .object({
      create: z
        .union([
...
export const Scope3CategoryCreateNestedManyWithoutScope3InputObjectSchema =
  Schema
