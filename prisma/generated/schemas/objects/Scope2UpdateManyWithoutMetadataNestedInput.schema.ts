...
const Schema: z.ZodType<Prisma.Scope2UpdateManyWithoutMetadataNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => Scope2UpdateManyWithWhereWithoutMetadataInputObjectSchema),
        z
          .lazy(() => Scope2UpdateManyWithWhereWithoutMetadataInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const Scope2UpdateManyWithoutMetadataNestedInputObjectSchema = Schema
