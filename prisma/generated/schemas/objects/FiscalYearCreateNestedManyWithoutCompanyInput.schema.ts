...
const Schema: z.ZodType<Prisma.FiscalYearCreateNestedManyWithoutCompanyInput> =
  z
    .object({
      create: z
        .union([
...
export const FiscalYearCreateNestedManyWithoutCompanyInputObjectSchema = Schema
