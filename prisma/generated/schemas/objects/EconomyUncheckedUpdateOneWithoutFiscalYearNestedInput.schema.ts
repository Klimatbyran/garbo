...
const Schema: z.ZodType<Prisma.EconomyUncheckedUpdateOneWithoutFiscalYearNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          ...
          z.lazy(
            () => EconomyUncheckedUpdateWithoutFiscalYearInputObjectSchema
          ),
        ])
        .optional(),
    })
...
export const EconomyUncheckedUpdateOneWithoutFiscalYearNestedInputObjectSchema =
  Schema
