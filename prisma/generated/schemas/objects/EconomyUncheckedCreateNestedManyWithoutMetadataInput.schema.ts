...
const Schema: z.ZodType<Prisma.EconomyUncheckedCreateNestedManyWithoutMetadataInput> =
  z
    .object({
      create: z
        .union([
...
export const EconomyUncheckedCreateNestedManyWithoutMetadataInputObjectSchema =
  Schema
