...
const Schema: z.ZodType<Prisma.MetadataUncheckedUpdateWithoutInitiativeInput> =
  z
    .object({
      id: z
        .union([
...
export const MetadataUncheckedUpdateWithoutInitiativeInputObjectSchema = Schema
