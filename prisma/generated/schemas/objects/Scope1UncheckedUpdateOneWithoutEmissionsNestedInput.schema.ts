...
const Schema: z.ZodType<Prisma.Scope1UncheckedUpdateOneWithoutEmissionsNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const Scope1UncheckedUpdateOneWithoutEmissionsNestedInputObjectSchema =
  Schema
