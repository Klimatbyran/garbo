...
const Schema: z.ZodType<Prisma.FiscalYearUncheckedUpdateWithoutCompanyInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const FiscalYearUncheckedUpdateWithoutCompanyInputObjectSchema = Schema
