...
const Schema: z.ZodType<Prisma.InitiativeCreateNestedManyWithoutCompanyInput> =
  z
    .object({
      create: z
        .union([
...
export const InitiativeCreateNestedManyWithoutCompanyInputObjectSchema = Schema
