...
const Schema: z.ZodType<Prisma.InitiativeUncheckedCreateNestedManyWithoutMetadataInput> =
  z
    .object({
      create: z
        .union([
...
export const InitiativeUncheckedCreateNestedManyWithoutMetadataInputObjectSchema =
  Schema
