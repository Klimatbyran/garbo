...
const Schema: z.ZodType<Prisma.EmissionsUncheckedCreateWithoutFiscalYearInput> =
  z
    .object({
...
export const EmissionsUncheckedCreateWithoutFiscalYearInputObjectSchema = Schema
