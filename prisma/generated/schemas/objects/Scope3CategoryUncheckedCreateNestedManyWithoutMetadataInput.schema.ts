...
const Schema: z.ZodType<Prisma.Scope3CategoryUncheckedCreateNestedManyWithoutMetadataInput> =
  z
    .object({
      create: z
        .union([
...
export const Scope3CategoryUncheckedCreateNestedManyWithoutMetadataInputObjectSchema =
  Schema
