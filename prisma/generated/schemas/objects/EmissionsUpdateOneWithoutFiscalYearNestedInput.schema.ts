...
const Schema: z.ZodType<Prisma.EmissionsUpdateOneWithoutFiscalYearNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const EmissionsUpdateOneWithoutFiscalYearNestedInputObjectSchema = Schema
