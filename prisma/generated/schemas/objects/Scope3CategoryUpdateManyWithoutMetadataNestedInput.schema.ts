...
const Schema: z.ZodType<Prisma.Scope3CategoryUpdateManyWithoutMetadataNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const Scope3CategoryUpdateManyWithoutMetadataNestedInputObjectSchema =
  Schema
