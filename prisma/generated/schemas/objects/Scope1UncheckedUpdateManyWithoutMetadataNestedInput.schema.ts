...
const Schema: z.ZodType<Prisma.Scope1UncheckedUpdateManyWithoutMetadataNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => Scope1UpdateManyWithWhereWithoutMetadataInputObjectSchema
          ),
          z
            .lazy(
              () => Scope1UpdateManyWithWhereWithoutMetadataInputObjectSchema
...
export const Scope1UncheckedUpdateManyWithoutMetadataNestedInputObjectSchema =
  Schema
