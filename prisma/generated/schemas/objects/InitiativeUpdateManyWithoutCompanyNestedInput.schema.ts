...
const Schema: z.ZodType<Prisma.InitiativeUpdateManyWithoutCompanyNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const InitiativeUpdateManyWithoutCompanyNestedInputObjectSchema = Schema
