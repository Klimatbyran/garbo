...
const Schema: z.ZodType<Prisma.Scope3UpdateManyWithoutMetadataNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => Scope3UpdateManyWithWhereWithoutMetadataInputObjectSchema),
        z
          .lazy(() => Scope3UpdateManyWithWhereWithoutMetadataInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const Scope3UpdateManyWithoutMetadataNestedInputObjectSchema = Schema
