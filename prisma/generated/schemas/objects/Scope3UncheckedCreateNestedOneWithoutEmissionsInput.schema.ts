...
const Schema: z.ZodType<Prisma.Scope3UncheckedCreateNestedOneWithoutEmissionsInput> =
  z
    .object({
      create: z
        .union([
...
export const Scope3UncheckedCreateNestedOneWithoutEmissionsInputObjectSchema =
  Schema
