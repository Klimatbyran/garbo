...
const Schema: z.ZodType<Prisma.Scope2UncheckedCreateNestedManyWithoutMetadataInput> =
  z
    .object({
      create: z
        .union([
...
export const Scope2UncheckedCreateNestedManyWithoutMetadataInputObjectSchema =
  Schema
