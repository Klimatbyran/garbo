...
const Schema: z.ZodType<Prisma.FiscalYearUpdateManyWithoutCompanyNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const FiscalYearUpdateManyWithoutCompanyNestedInputObjectSchema = Schema
