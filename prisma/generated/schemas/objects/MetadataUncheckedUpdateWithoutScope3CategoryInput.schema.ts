...
const Schema: z.ZodType<Prisma.MetadataUncheckedUpdateWithoutScope3CategoryInput> =
  z
    .object({
      id: z
        .union([
      ...
      goal: z
        .lazy(
          () => GoalUncheckedUpdateManyWithoutMetadataNestedInputObjectSchema
        )
        .optional(),
      initiative: z
        .lazy(
...
export const MetadataUncheckedUpdateWithoutScope3CategoryInputObjectSchema =
  Schema
