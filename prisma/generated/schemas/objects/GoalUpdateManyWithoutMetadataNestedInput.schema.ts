...
const Schema: z.ZodType<Prisma.GoalUpdateManyWithoutMetadataNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => GoalUpsertWithWhereUniqueWithoutMetadataInputObjectSchema),
        z
          .lazy(() => GoalUpsertWithWhereUniqueWithoutMetadataInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => GoalUpdateWithWhereUniqueWithoutMetadataInputObjectSchema),
        z
          .lazy(() => GoalUpdateWithWhereUniqueWithoutMetadataInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const GoalUpdateManyWithoutMetadataNestedInputObjectSchema = Schema
