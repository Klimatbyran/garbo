...
const Schema: z.ZodType<Prisma.EmissionsCreateNestedOneWithoutFiscalYearInput> =
  z
    .object({
      create: z
        .union([
...
export const EmissionsCreateNestedOneWithoutFiscalYearInputObjectSchema = Schema
