...
const Schema: z.ZodType<Prisma.EconomyUpdateManyWithoutMetadataNestedInput> = z
  .object({
    create: z
      .union([
...
export const EconomyUpdateManyWithoutMetadataNestedInputObjectSchema = Schema
