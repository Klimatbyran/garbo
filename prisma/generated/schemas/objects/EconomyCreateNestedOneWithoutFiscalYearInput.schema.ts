...
const Schema: z.ZodType<Prisma.EconomyCreateNestedOneWithoutFiscalYearInput> = z
  .object({
    create: z
      .union([
...
export const EconomyCreateNestedOneWithoutFiscalYearInputObjectSchema = Schema
