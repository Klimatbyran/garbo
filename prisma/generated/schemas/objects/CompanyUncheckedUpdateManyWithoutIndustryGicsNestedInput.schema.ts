...
const Schema: z.ZodType<Prisma.CompanyUncheckedUpdateManyWithoutIndustryGicsNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const CompanyUncheckedUpdateManyWithoutIndustryGicsNestedInputObjectSchema =
  Schema
