...
const Schema: z.ZodType<Prisma.GoalUncheckedCreateNestedManyWithoutMetadataInput> =
  z
    .object({
      create: z
        .union([
...
export const GoalUncheckedCreateNestedManyWithoutMetadataInputObjectSchema =
  Schema
