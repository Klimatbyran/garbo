...
const Schema: z.ZodType<Prisma.Scope3CategoryUpdateManyWithoutScope3NestedInput> =
  z
    .object({
      create: z
        .union([
...
export const Scope3CategoryUpdateManyWithoutScope3NestedInputObjectSchema =
  Schema
