...
const Schema: z.ZodType<Prisma.InitiativeUncheckedUpdateManyWithoutMetadataNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const InitiativeUncheckedUpdateManyWithoutMetadataNestedInputObjectSchema =
  Schema
