...
const Schema: z.ZodType<Prisma.GoalUncheckedUpdateManyWithoutCompanyNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => GoalUpsertWithWhereUniqueWithoutCompanyInputObjectSchema
          ),
          z
            .lazy(
              () => GoalUpsertWithWhereUniqueWithoutCompanyInputObjectSchema
      ...
      update: z
        .union([
          z.lazy(
            () => GoalUpdateWithWhereUniqueWithoutCompanyInputObjectSchema
          ),
          z
            .lazy(
              () => GoalUpdateWithWhereUniqueWithoutCompanyInputObjectSchema
...
export const GoalUncheckedUpdateManyWithoutCompanyNestedInputObjectSchema =
  Schema
