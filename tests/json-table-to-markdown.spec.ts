...
describe('Table Parser', () => {
  ...
  test('should correctly parse Vattenfall emissions table with multi-level headers', () => {
    const inputBlock = {
      bbox: [256.45, 96.95, 569.95, 103.95],
      block_class: 'cls_28',
      block_idx: 3755,
      level: 13,
      page_idx: 145,
      ...
      table_rows: [
        ...
        },
        {
          ...
          cells: [
            {
              cell_value:
                'E1-6 Bruttoväxthusgasutsläpp inom scope 1, 2, 3 och totala växthusgasutsläpp1',
            },
            { cell_value: '2017' },
            { cell_value: '2023' },
            { cell_value: '2024' },
        ...
        },
        {
          ...
          cells: [
            {
              cell_value:
                'Utsläppsminskningsmål godkända av SBTi3 Scope 1 och 2 (marknadsbaserade) intensitet, gCO2e/kWh',
            },
            { cell_value: '110,4' },
            { cell_value: '33,5' },
            { cell_value: '33,7' },
        ...
        },
        {
          ...
          cells: [
            {
              cell_value:
                'Scope 1 och Scope 3 Såld elektricitet, intensitet, gCO2e/kWh',
            },
            { cell_value: '199,1' },
            { cell_value: '88,7' },
            { cell_value: '66,6' },
  ...
  test('should handle table with single header row', () => {
    const inputBlock: NLMIngestorTable = {
      ...
      table_rows: [
        {
          block_idx: 1,
          cells: [{ cell_value: 'Name' }, { cell_value: 'Value' }],
          type: 'table_header',
        },
        {
          block_idx: 2,
          cells: [{ cell_value: 'Item A' }, { cell_value: '100' }],
          type: 'table_data_row',
        },
      ],
    }
  ...
  test('should handle table without bbox', () => {
    const inputBlock: NLMIngestorTable = {
      ...
      table_rows: [
        {
          block_idx: 1,
          cells: [{ cell_value: 'Col1' }, { cell_value: 'Col2' }],
          type: 'table_header',
        },
      ],
    }
